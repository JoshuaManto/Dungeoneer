...
CREATE TABLE "Users-Characters" (
	...
	"character_id" integer NOT NULL,
	CONSTRAINT "Users-Characters_pk" PRIMARY KEY ("user_character_id")
) WITH (
  OIDS=FALSE
);
...
ALTER TABLE "Spells_List" ADD CONSTRAINT "Spells_List_fk0" FOREIGN KEY ("character_id") REFERENCES "Characters"("characters_id");
...
ALTER TABLE "Users-Characters" ADD CONSTRAINT "Users-Characters_fk0" FOREIGN KEY ("user_id") REFERENCES "users"("user_id");
ALTER TABLE "Users-Characters" ADD CONSTRAINT "Users-Characters_fk1" FOREIGN KEY ("character_id") REFERENCES "Characters"("characters_id");
